    ...
    return(
        <div className="space-y-4 lg:flex">
            <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end">
                ...
                <img src="./assets/Pink-Shape.svg" alt="2nt" className="absolute -rotate-[30deg] h-64 md:h-72 lg:h-[400px]"/>
                <img src="./assets/Purple-Shape.svg" alt="3rdt" className="absolute -rotate-[15deg] h-64 md:h-72 lg:h-[400px]" />
